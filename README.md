...
Versión **0.0.1**. Cambios: [CHANGELOG.md](CHANGELOG.md). Plan: [docs/roadmap.md](docs/roadmap.md).
...
- Mazos semilla desde el temario de OpoTest (Constitución, LPACAP, Ley 40/2015, TREBEP) y un mazo de redes.
...
# o un dispositivo Android conectado
```

Requiere Flutter 3.29 (SDK Dart ^3.7.2).
